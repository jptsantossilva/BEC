...
minPositionSize = 10 # minimum position size in usd
...
# %%
# MIN_NOTIONAL error
# info = client.get_symbol_info('MATICBUSD')
# print(info)
...
try:
    ...
    sendTelegramMessage(eWarning, "Oops! Error code:"+ e.status_code + " - " + e.message)
